...
namespace ProfileMatch.Components.SuperUser
{
    public partial class SuperUserPeopleList : ComponentBase
    {
        [Inject]
        ...
        private async Task EditProfile(ApplicationUser applicationUser)
        {
            ...
            var dialog = DialogService.Show<SuperUserUserDialog>($"Edit User {applicationUser.FirstName}, {applicationUser.LastName} data", parameters, maxWidth);
            await dialog.Result;
        }
    }
}