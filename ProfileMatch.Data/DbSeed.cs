...
namespace ProfileMatch.Data
{
    ...
    {
        public static void PopulateSeeds(this ModelBuilder builder)
        {
            ...
            {//a hasher to hash the password before seeding the user to the db
                ...
                user.HasData(new ApplicationUser
                {
                    ...
                    IsActive = true,
                    PhotoPath = "/images/blank-profile.png",
                    DateOfBirth = new DateTime(day: 5, month: 3, year: 2004)
                });
                user.HasData(new ApplicationUser
                {
                    ...
                    IsActive = true,
                    PhotoPath = "/images/blank-profile.png",
                    DateOfBirth = new DateTime(day: 24, month: 12, year: 1980)
                });
            });
