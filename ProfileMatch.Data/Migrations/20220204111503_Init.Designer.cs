...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.AnswerOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7591f3af-806d-41fd-9381-2178636915ca",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELxAQp48nMeXPTJ91XkbXqG1d9JA+yC8eotnWvmnCvcxX94wq/n8OYaCk/lfbB93UQ==",
                            PhoneNumberConfirmed = false,
                            PhotoPath = "/images/blank-profile.png",
                            SecurityStamp = "8c527367-1588-4c34-9251-916bf448b8e5",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "adad1707-f051-402b-8924-9d33bf39770a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJeusjrOx0yvRg+8C7xX8TV6CfuVBuDmdIeiAQO+ec9I0ljh4eS5rpL7TwqiGTbn+Q==",
                            PhoneNumberConfirmed = false,
                            PhotoPath = "/images/blank-profile.png",
                            SecurityStamp = "2410cff7-be1f-4046-9309-da398670c9dd",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fcf34dd8-4e92-4f03-bc7e-c428ccb3f248",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEG16RVYA9or8ZXaI3CqIHDiBHZtxge7sJiKRUZayJXrzdY5aeo6/C+j6baxGK3USHw==",
                            PhoneNumberConfirmed = false,
                            PhotoPath = "/images/blank-profile.png",
                            SecurityStamp = "0f244f12-9fa2-44c9-bb8d-532c8e061465",
                            TwoFactorEnabled = false,
                            UserName = "user@user.com"
                        });
                });

            modelBuilder.Entity("ProfileMatch.Models.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.Certificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.ClosedQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.OpenQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.UserCategory", b =>
                {
                    b.Property<string>("ApplicationUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.UserClosedAnswer", b =>
                {
                    b.Property<string>("ApplicationUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.UserOpenAnswer", b =>
                {
                    b.Property<string>("ApplicationUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProfileMatch.Models.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.AnswerOption", b =>
                {
                    b.HasOne("ProfileMatch.Models.Entities.ClosedQuestion", "ClosedQuestion")
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.ApplicationUser", b =>
                {
                    b.HasOne("ProfileMatch.Models.Entities.Department", "Department")
                        .WithMany("ApplicationUsers")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProfileMatch.Models.Entities.Job", "Job")
                        .WithMany("ApplicationUsers")
                        .HasForeignKey("JobId")
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.Certificate", b =>
                {
                    b.HasOne("ProfileMatch.Models.Entities.ApplicationUser", "ApplicationUser")
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.ClosedQuestion", b =>
                {
                    b.HasOne("ProfileMatch.Models.Entities.Category", "Category")
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.UserClosedAnswer", b =>
                {
                    b.HasOne("ProfileMatch.Models.Entities.AnswerOption", "AnswerOption")
            ...
            modelBuilder.Entity("ProfileMatch.Models.Entities.UserOpenAnswer", b =>
                {
                    ...
                    b.HasOne("ProfileMatch.Models.Entities.OpenQuestion", "OpenQuestion")
